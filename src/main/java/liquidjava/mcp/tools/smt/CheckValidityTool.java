 ...
 */
public final class CheckValidityTool extends AbstractSmtTool<ValidityRequest, ValidityResult> {
    ...
    public CheckValidityTool(Function<ValidityRequest, ValidityResult> checker, McpJsonMapper jsonMapper) {
        ...
        """, checker, message -> ValidityResult.failed(McpError.Code.INVALID_INPUT, message), jsonMapper);
    }

    public CallToolResult call(Map<String, Object> arguments) {
        return handleSmtRequest(arguments, ValidityRequest::fromArguments, "counterexample");
    }
}
